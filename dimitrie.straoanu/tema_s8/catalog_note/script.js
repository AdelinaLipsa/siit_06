window.addEventListener("DOMContentLoaded", function () {
    ...
    function addStudent() {
        ...
        nameInput.value = "";
        return serverRequest('POST', `https://test-project-5014c.firebaseio.com/students_list.json`, newStudent)
    }
    ...
    function addGrade() {
        ...
        gradeInput.value = "";
        return serverRequest('PUT', `https://test-project-5014c.firebaseio.com/students_list/${key}/grades/${grades.length}.json`, newGrade)
    }
    ...
    function getDatabase() {
        return serverRequest('GET', 'https://test-project-5014c.firebaseio.com/students_list.json');
    }
